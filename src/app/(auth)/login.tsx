...
export default function LoginScreen() {
	...
	//const loginHandler: SubmitHandler<LoginFormType> = async (
	//	d: LoginFormType
	//) => {
	//	try {
	//		setIsLoading(true);
	//
	//		const _uri = "https://auth.yogayukt.com/auth/login";
	//		console.log(d, "-data");
	//
	//		const response = await axios.post(_uri, d);
	//
	//		console.log("response", response);
	//		// Handle successful login here (e.g., store tokens, navigate to home screen)
	//	} catch (error) {
	...
	//};
	//
	const loginHandler = () => router.push("/verifyOTP");
